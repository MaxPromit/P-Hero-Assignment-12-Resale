...
const AddProducts = () => {
    ...
    const {data: catagoryInfo= [], isLoading} = useQuery({
    ...
    return (
        ...
        <label className="label">
             ...
             {...register("productCatagory", {
              ...
              className="select select-bordered w-full max-w-xs mb-5">
                 {catagoryInfo.map(catagory =>  <option
                  key={catagory._id}
                  >{catagory.brand}</option>)}
              </select>
        <div className="form-control w-full">
          <label className="label">
        ...
        <select className="my-3" {...register("location", {
        ...
        <select className="my-3" {...register("conditionType",
             { required: true }
           )}>
       ...
       <label className="label">
        ...
        <textarea className='w-full' {...register("description", {required: 'Message Needed'}) }/>
       </div>
